<body>
	 ...
	 <section class="w3l-workinghny-form">
        ...
        <div class="workinghny-form-grid">
            <div class="wrapper">
                <div class="logo">
                    <h1><a class="brand-logo" href=<?php echo $level."index.php"?>>Forgot Password</a></h1>
                ...
                <div class="workinghny-block-grid">
                    ...
                    <div class="form-right-inf">
                        ...
                        <div class="login-form-content">
                            <h2>Where to?</h2>
                            <form action="<?php echo $level.MAIL."forgotpassword.php"?>" class="signin-form" method="post" style="margin-bottom:300px;">
								<div class="one-frm">
