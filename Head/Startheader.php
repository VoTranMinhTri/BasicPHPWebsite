	...
	<div class="header">
		...
		<ul class="icon1 sub-icon1">
			<li><a class="active-icon c1" href="<?php echo $level.PAGES."cart.php"?>"><i>Cart</i></a>
				...
				$item=$_SESSION['cart'];
				?>
					<li><h3><?php echo '<p>You have <a href="'?><?php echo $level.PAGES.'cart.php">'?><?php echo count($item).' Item in cart<a/></p>';?></h3><a href=""></a></li>
		...
		<div class="h_search">
			<form action="<?php echo $level.PAGES."ketqua.php"?>" method="get">
    			<input type="text" name="txtsearch" value="" placeholder="Search product, brand you want">
