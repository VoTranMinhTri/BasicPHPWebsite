<div class="content-wrapper">
	...
	<div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-warning">
              <div class="inner">
                <h3><i class="fas fa-user"></i><?php echo " ".$SOLUONG[0][0]?></h3>
                <p style="color:white;">NUMBER OF VISITORS</p>
              </div>
			   <p class="small-box-footer">ADITII FASHION</p>
            </div>
          </div>
	  </div>
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="card card-danger">
              <div class="card-header">
                <h3 class="card-title">Top 5 best selling products of the year</h3>
  ...
  <!-- STACKED BAR CHART -->
            <div class="card card-danger">
              <div class="card-header">
                <h3 class="card-title">Revenue of each month</h3>
          ...
          <div class="col-md-6">
           <!-- BAR CHART -->
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Top selling products (first 6 months)</h3>
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Top selling products (last 6 months)</h3>
