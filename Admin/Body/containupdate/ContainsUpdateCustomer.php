        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?php echo $level.DATABASE.UPDATE.CUSTOMER."index_updatecustomer.php"?>" method="get">
                <div class="card-body">
				<div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="TENKH" placeholder="Enter"value="<?php echo $rowdata[0]['TENKH']?>">
                  </div>
				   <div class="form-group">
                    <label >ADDRESS</label>
